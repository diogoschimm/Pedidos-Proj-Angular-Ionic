...
/***/ "./src/app/pedido-list.ts":
/*!********************************!*\
  !*** ./src/app/pedido-list.ts ***!
  \********************************/
/*! exports provided: PedidoList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PedidoList", function() { return PedidoList; });
var PedidoList = /** @class */ (function () {
    function PedidoList() {
    }
    return PedidoList;
}());
...
/* harmony import */ var _pedido_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pedido-list */ "./src/app/pedido-list.ts");
...
var PedidoService = /** @class */ (function () {
    function PedidoService(storage, datepipe) {
        this.storage = storage;
        this.datepipe = datepipe;
    }
    PedidoService.prototype.increment = function () {
        var _this = this;
        return this.storage.get('pedidoSequence').then(function (value) {
            var id = 0;
            if (value) {
                id = value;
            }
            return _this.setProximoId(id + 1);
        });
    };
    PedidoService.prototype.insert = function (pedido) {
        var _this = this;
        return this.increment().then(function () {
            var proxId = 0;
            return _this.storage.get('pedidoSequence').then(function (value) {
                if (value) {
                    proxId = value;
                    pedido.id = proxId;
                    _this.pedidoSalvo = pedido;
                    return _this.save(pedido.key, pedido);
                }
                else {
    ...
    PedidoService.prototype.update = function (pedido) {
        return this.save(pedido.key, pedido);
    };
    PedidoService.prototype.delete = function (key) {
        return this.storage.remove(key);
    };
    PedidoService.prototype.save = function (key, pedido) {
        var _this = this;
        return this.storage.remove(key).then(function () {
            return _this.storage.set(key, pedido);
        });
    };
    PedidoService.prototype.setProximoId = function (id) {
        var _this = this;
        return this.storage.remove('pedidoSequence').then(function () {
            return _this.storage.set('pedidoSequence', id);
        });
    };
    PedidoService.prototype.getChave = function (key) {
    ...
    PedidoService.prototype.getAll = function () {
        ...
        return this.storage.forEach(function (value, key, iterationNumber) {
            if (key.includes('pedido_')) {
                var pedido = new _pedido_list__WEBPACK_IMPORTED_MODULE_4__["PedidoList"]();
                pedido.key = key;
                pedido.pedido = value;
                pedidos.push(pedido);
            }
    ...
    PedidoService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"]])
    ], PedidoService);
...
/* harmony import */ var _cliente__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cliente */ "./src/app/cliente.ts");

var Pedido = /** @class */ (function () {
    function Pedido() {
        this.cliente = new _cliente__WEBPACK_IMPORTED_MODULE_0__["Cliente"]();
    }
    Pedido.prototype.getHora = function () {
        return;
    };
    return Pedido;
}());
